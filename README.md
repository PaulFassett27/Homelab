...
<body>
  Right of the bat I set up a Pi Hole on my Raspberry Pi and configured it to be the main DNS server for my devices such as me and my wifes phones and our tv. I found that there was a few confgiurations that Pi Hole was lacking so I switched to Adguard as I feel as if it was more robust and allowed me to have more control over the DNS settings.
</body>
